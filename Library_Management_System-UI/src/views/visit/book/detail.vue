        ...
        <el-card shadow="hover" :body-style="{ padding: '0px' }">
          ...
          >
            ...
            <el-form-item prop="name" label="书名" width="150" align="center">
              <el-input
                v-model="book.name"
                placeholder="书名不需要带书名号"
                disabled
              />
            </el-form-item>
            <el-form-item prop="author" label="作者" width="150" align="center"
              ><el-input v-model="book.author" disabled
            /></el-form-item>

            <el-form-item prop="publishingHouse" label="出版社">
              <el-input v-model="book.publishingHouse" disabled></el-input>
            </el-form-item>
            ...
            <el-form-item
              ...
              width="150"
              align="center"
              ><el-input v-model="book.place" disabled
            /></el-form-item>

            <el-form-item label="描述" prop="description">
              <el-input v-model="book.description" disabled />
            </el-form-item>
            <el-form-item
              prop="state"
              label="状态"
